...
OpenShiftClient.prototype._request = function(path, method, body, callback) {
    ...
    this._addOpenShiftApiVersion(requestOptions);
...
OpenShiftClient.prototype._addOpenShiftApiVersion = function(requestOptions, options) {
    "use strict";
    var defaults = {
        "openShiftApiVersion": OPENSHIFT_API_VERSION
    };
    options = underscore.defaults(options || {}, defaults);

    if (options.openShiftApiVersion) {
        requestOptions.headers.Accept = "application/json; version=" + options.openShiftApiVersion;
    }
};
